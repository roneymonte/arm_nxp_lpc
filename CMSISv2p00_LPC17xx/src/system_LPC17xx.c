...
#define CCLKCFG_Val           0x00000003	//CCLKCFG  = DIVISOR DE CLOCK /4
#define USBCLKCFG_Val         0x00000000	//usado caso o PLL1_SETUP nao for configurado
#define PCLKSEL0_Val          0x00000000	//Selecao do Periferico de Clock
#define PCLKSEL1_Val          0x00000000	//Selecao do Periferico de Clock
